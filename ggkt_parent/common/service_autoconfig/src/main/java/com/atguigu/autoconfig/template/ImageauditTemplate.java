...
import com.atguigu.autoconfig.properties.GreenProperties;
 ...
 */
@Slf4j
public class ImageauditTemplate {

    private Client client;

    private GreenProperties greenProperties;

    public ImageauditTemplate(GreenProperties properties) {
        try {
    ...
    public Map<String, String> imageScan(List<String> imageUrls) throws Exception {
        ...
        ScanImageRequest scanImageRequest = new ScanImageRequest()
                .setTask(list).setScene(Arrays.asList(
                        scenesStr));
        //  Results=[
